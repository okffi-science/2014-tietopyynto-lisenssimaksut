...
```{r ranking1, cache=FALSE, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=5, fig.show = "hold", out.width = "2000px"}
# Ranking variables
...
`r figs("ranking1", "University ranking variables versus subscription costs with selected publishers.")`
