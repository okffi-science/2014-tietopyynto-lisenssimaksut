...
```{r ranking1, cache=FALSE, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, fig.show = "hold", out.width = "430px"}
# Ranking variables
...
```{r rankingeter, cache=FALSE, echo=FALSE, message=FALSE, warning=FALSE, fig.width=14, fig.height=6, fig.show = "hold", out.width = "290px"}
